...
class Board:
    ...
    def count_unique_positions(self, position_char: str) -> int:
        """Count the number of unique positions in the board.

        Args:
            position_char (str): The character representing a position.
...
def main() -> None:
    ...
    guard.walk()
    print(guard.board.count_unique_positions(position_char="X"))
